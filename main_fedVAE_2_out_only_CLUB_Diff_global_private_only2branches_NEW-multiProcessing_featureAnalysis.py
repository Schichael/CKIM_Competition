...
from federatedscope.contrib.trainer.feature_analysis_laplacian_trainer_dom_sep_2_out_only_CLUB_diff_sim_only2branches_NEW import \
    call_laplacian_trainer
from federatedscope.contrib.workers.feature_analysis_laplacian_with_domain_separation_2_out_only_CLUB_Diff_only2branches_NEW_client import \
    FeatureAnalysisLaplacianDomainSeparationVAE_2Out_OnlyCLUBDiffSim_only2branches_NEW_Client
...
def train(lr, kld_ne_imp, diff_imp_global, diff_imp_local, csd_imp):
    ...
    init_cfg.data.save_dir = \
        'FeatureAnalysisGraph-DC_2_out_only_CLUB_Diff_global_private_only_2_branches_NEW_sim_loss_lr_' + str(lr).replace(
    ...
    runner = FedRunner(data=data,
                   ...
                   client_class = FeatureAnalysisLaplacianDomainSeparationVAE_2Out_OnlyCLUBDiffSim_only2branches_NEW_Client,
