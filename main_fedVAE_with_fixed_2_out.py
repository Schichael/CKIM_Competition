...
from federatedscope.contrib.trainer.laplacian_trainer_dom_sep_VAE_2_out import call_laplacian_trainer
...
def train(lr, kld_ne_imp, kld_local_imp, kld_interm_imp, kld_global_imp, recon_imp, diff_interm_imp,
    ...
    init_cfg.data.save_dir = 'Graph-DC_FedVAE_with_fixed_2_out_lr_' + str(lr).replace('.', '_')
    ...
    runner = FedRunner(data=data,
                   ...
                   client_class= LaplacianDomainSeparationVAE_2_out_Client,
