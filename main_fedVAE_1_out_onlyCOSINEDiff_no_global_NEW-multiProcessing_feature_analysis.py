...
from federatedscope.contrib.workers\
    .feature_analysis_laplacian_with_domain_separation_1_out_noGlobal_NEW_client import \
    FeatureAnalysisLaplacianDomainSeparationVAE_1_out_onlyDiff_noGlobal_NEW_Client
...
def train(lr, kld_ne_imp, diff_interm_imp, diff_local_imp, csd_imp):
    ...
    init_cfg.data.save_dir = \
        ...
        '-DC_FedVAE_1_out_only_COSINEDiff_no_global_NEW_sim_loss_lr_' + str(
    ...
    init_cfg.params.model_path = '/home/michael/Dropbox/Master thesis/results_graph_dc_new_lr_0_5/1_out/simple/cosine/corrected/multi_runs/TGraph-DC_FedVAE_1_out_only_COSINEDiff_no_global_multi_run_lr_0_05_A0_F0_5_G0_5_H10/FedDomSep_GraphDC_gin_on_fs_contest_data_lr0.05_lstep1_'
    ...
    runner = FedRunner(data=data,
                   ...
                   client_class = FeatureAnalysisLaplacianDomainSeparationVAE_1_out_onlyDiff_noGlobal_NEW_Client,
...
if __name__ == '__main__':
    ...
    diff_interm_imps = [0.5] #F    HERE  [0.0001, 0.001]
    diff_local_imps = [0.5] #G
    csd_imp = 10 #H
    ...
    processes = []
    for lr in lrs:
            for diff_interm_imp in diff_interm_imps:
