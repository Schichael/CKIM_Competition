...
def use_diff_laplacian_nova(func):
    def wrapper(self, *args, **kwargs):
        if self.cfg.federate.use_diff:
            # TODO: any issue for subclasses?
            before_metric = self.evaluate(target_data_split_name='val')

        num_samples_train, model_para, omega, result_metric, num_rounds = func(
            self, *args, **kwargs)
        ...
        return num_samples_train, model_para, omega, result_metric, num_rounds
