...
from federatedscope.contrib.trainer.laplacian_trainer_dom_sep_2_out_only_diffMINE_proxLoss_NEW import \
    LaplacianDomainSeparationVAE_2Out_OnlyDiffMINE_ProxLoss_NEW_Trainer
from federatedscope.contrib.trainer.laplacian_trainer_dom_sep_2_out_only_diffMINE_sim_NEW import \
    LaplacianDomainSeparationVAE_2Out_OnlyDiffMINE_Sim_NEW_Trainer
...
class LaplacianDomainSeparationVAE_2_out_onlyDiffMINE_Sim_NEW_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparationVAE_2Out_OnlyDiffMINE_Sim_NEW_Trainer(
            model=model,
