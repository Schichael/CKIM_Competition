...
from federatedscope.contrib.trainer.laplacian_trainer_dom_sep_1_out_only_diff_no_global_with_VAE import \
    LaplacianDomainSeparationVAE_1Out_OnlyDiff_noGlobal_with_VAE_Trainer
...
class LaplacianDomainSeparationVAE_1_out_onlyDiff_noGlobal_with_VAE_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparationVAE_1Out_OnlyDiff_noGlobal_with_VAE_Trainer(
            model=model,
