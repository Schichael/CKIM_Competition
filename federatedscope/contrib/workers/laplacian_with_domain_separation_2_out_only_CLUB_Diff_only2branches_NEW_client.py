...
from federatedscope.contrib.trainer\
    ...
    LaplacianDomainSeparationVAE_2Out_OnlyCLUBDiffSim_only2branches_NEW_Trainer
...
class LaplacianDomainSeparationVAE_2_out_only_CLUB_Diff_only2branches_NEW_Client(
    Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
        ...
        trainer = LaplacianDomainSeparationVAE_2Out_OnlyCLUBDiffSim_only2branches_NEW_Trainer(
            model=model,
