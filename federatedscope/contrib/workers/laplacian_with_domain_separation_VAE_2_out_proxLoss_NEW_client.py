...
from federatedscope.contrib.trainer.laplacian_trainer_dom_sep_VAE_2_out_prox_loss_NEW import \
    LaplacianDomainSeparationVAE_2Out_proxLoss_NEW_Trainer
...
class LaplacianDomainSeparationVAE_2_out_proxLoss_NEW_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparationVAE_2Out_proxLoss_NEW_Trainer(
            model=model,
