...
from federatedscope.contrib.trainer.laplacian_trainer_with_domain_separation_with_summation_MI import \
    LaplacianDomainSeparationWithSummationMITrainer
...
class LaplacianDomainSeparationMIClient(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparationWithSummationMITrainer(
            model=model,
