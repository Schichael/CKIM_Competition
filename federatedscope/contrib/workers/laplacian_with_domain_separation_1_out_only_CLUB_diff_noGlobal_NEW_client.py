...
class LaplacianDomainSeparationVAE_1_out_onlyCLUB_Diff_noGlobal_NEW_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparation_1Out_OnlyCLUBDiff_noGlobal_NEW_Trainer(
            model=model,
