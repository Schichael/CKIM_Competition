...
class LaplacianDomainSeparationVAE_2_out_onlyDiffMINE_ProxLoss_NEW_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparationVAE_2Out_OnlyDiffMINE_ProxLoss_NEW_Trainer(
            model=model,
