...
from federatedscope.contrib.trainer\
    .feature_analysis_laplacian_trainer_dom_sep_1_out_only_diff_no_global_NEW import \
    FeatureAnalysisLaplacianDomainSeparationVAE_1Out_OnlyDiff_noGlobal_NEW_Trainer
from federatedscope.contrib.trainer\
...
class FeatureAnalysisLaplacianDomainSeparationVAE_1_out_onlyDiff_noGlobal_NEW_Client(
    Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
        ...
        trainer = FeatureAnalysisLaplacianDomainSeparationVAE_1Out_OnlyDiff_noGlobal_NEW_Trainer(
            model=model,
