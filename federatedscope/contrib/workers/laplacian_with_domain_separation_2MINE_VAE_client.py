...
from federatedscope.contrib.trainer.laplacian_trainer_with_domain_separation_with_summation_2MINE_VAE import \
    LaplacianDomainSeparation2MINEVAETrainer
...
class LaplacianDomainSeparation2MINEClient(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparation2MINEVAETrainer(
            model=model,
