...
class LaplacianDomainSeparationVAE_2_out_onlyDiff_only2branches_NEW_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparationVAE_2Out_OnlyDiffSim_only2branches_NEW_Trainer(
            model=model,
