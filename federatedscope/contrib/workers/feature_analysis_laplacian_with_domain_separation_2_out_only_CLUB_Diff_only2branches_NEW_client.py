...
from federatedscope.contrib.trainer.feature_analysis_laplacian_trainer_dom_sep_2_out_only_CLUB_diff_sim_only2branches_NEW import \
    FeatureAnalysisLaplacianDomainSeparationVAE_2Out_OnlyCLUBDiffSim_only2branches_NEW_Trainer
from federatedscope.contrib.trainer.feature_analysis_laplacian_trainer_resnet import \
    FeatureAnalysisLaplacianResNet_Trainer
...
class FeatureAnalysisLaplacianDomainSeparationVAE_2Out_OnlyCLUBDiffSim_only2branches_NEW_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = FeatureAnalysisLaplacianDomainSeparationVAE_2Out_OnlyCLUBDiffSim_only2branches_NEW_Trainer(
            model=model,
