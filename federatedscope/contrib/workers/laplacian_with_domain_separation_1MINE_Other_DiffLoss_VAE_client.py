...
from federatedscope.contrib.trainer.laplacian_trainer_with_domain_separation_with_summation_1MINE_otherDiffLoss_VAE import \
    LaplacianDomainSeparation1MINE_Other_Diff_VAETrainer
...
class LaplacianDomainSeparation1MINEOtherDiffClient(Client):
    def __init__(self,
        ...
        trainer = LaplacianDomainSeparation1MINE_Other_Diff_VAETrainer(
            model=model,
