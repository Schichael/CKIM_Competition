...
from federatedscope.contrib.trainer.laplacian_trainer_with_domain_separation_VAE_separated_other_diff_other_sim import \
    LaplacianDomainSeparationVAE_Separated_OtherDiff_OtherSim_Trainer
...
class LaplacianDomainSeparation1MINE_Separated_OtherDiff_OtherSim_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparationVAE_Separated_OtherDiff_OtherSim_Trainer(
            model=model,
