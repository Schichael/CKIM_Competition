...
from federatedscope.contrib.trainer.laplacian_trainer_diff_global_out import LaplacianDiffGlobalOutTrainer
...
class LaplacianDiffGlobalOutClient(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDiffGlobalOutTrainer(
            model=model,
