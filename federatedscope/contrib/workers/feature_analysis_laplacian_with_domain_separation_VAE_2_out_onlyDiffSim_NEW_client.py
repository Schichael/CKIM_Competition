...
from federatedscope.contrib.trainer.feature_analysis_laplacian_trainer_dom_sep_2_out_only_diff_sim_NEW import \
    FeatureAnalysisLaplacianDomainSeparationVAE_2Out_OnlyDiffSim_NEW_Trainer
...
class FeatureAnalysis_LaplacianDomainSeparationVAE_2_out_onlyDiffSim_NEW_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = FeatureAnalysisLaplacianDomainSeparationVAE_2Out_OnlyDiffSim_NEW_Trainer(
            model=model,
