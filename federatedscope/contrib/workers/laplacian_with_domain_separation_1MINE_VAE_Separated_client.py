...
from federatedscope.contrib.trainer.laplacian_trainer_with_domain_separation_with_summation_1MINE_VAE_separated import \
    LaplacianDomainSeparation1MINEVAE_Separated_Trainer
...
class LaplacianDomainSeparation1MINE_Separated_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparation1MINEVAE_Separated_Trainer(
            model=model,
