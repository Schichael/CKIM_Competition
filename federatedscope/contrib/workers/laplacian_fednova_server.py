...
from federatedscope.contrib.aggregator.laplacian_fednova_aggregator import \
    LaplacianNovaAggregator
...
class LaplacianServer(Server):
    def __init__(self,
        ...
        #                                 config=config,
        #                                 )
        aggregator = LaplacianNovaAggregator(model=model,
            ...
            if not check_eval_result:  # in the training process
                ...
                for model_idx in range(self.model_num):
                    ...
                    with torch.no_grad():
                        ...
                        model.load_state_dict(new_param, strict=False)
                        for name, param in self.model.named_parameters():
                            #self.model.state_dict()[name].data.copy_(new_param[
