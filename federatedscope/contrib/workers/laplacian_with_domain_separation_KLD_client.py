...
from federatedscope.contrib.trainer.laplacian_trainer_with_domain_separation_KLD import \
    LaplacianDomainSeparationKLDTrainer
...
class LaplacianDomainSeparation_KLD_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparationKLDTrainer(
            model=model,
