...
from federatedscope.contrib.trainer.laplacian_trainer_dom_sep_2_only_diff_proxLoss_decoder_3_steps_NEW import \
    LaplacianDomainSeparationVAE_2Out_OnlyDiffProxLoss_Decoder_3_steps_NEW_Trainer
...
from federatedscope.contrib.trainer.laplacian_trainer_dom_sep_2_out_only_diff_proxLoss_decoder_NEW import \
    LaplacianDomainSeparationVAE_2Out_OnlyDiffProxLoss_Decoder_NEW_Trainer
...
class LaplacianDomainSeparationVAE_2_out_onlyDiffProxLoss_Decoder_3_steps_NEW_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparationVAE_2Out_OnlyDiffProxLoss_Decoder_3_steps_NEW_Trainer(
            model=model,
