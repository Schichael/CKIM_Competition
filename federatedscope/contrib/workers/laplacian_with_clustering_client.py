...
from federatedscope.contrib.trainer.laplacian_with_clustering_trainer import LaplacianClusteringTrainer
...
class LaplacianClusteringClient(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianClusteringTrainer(
            model=model,
