...
from federatedscope.contrib.trainer.laplacian_trainer_dom_sep_1_out_only_COSINE_diff_no_global_recon_loss_NEW import \
    LaplacianDomainSeparation_1Out_OnlyCOSINEDiff_noGlobal_RECON_Loss_NEW_Trainer
...
class LaplacianDomainSeparationVAE_1_out_onlyCLUB_Diff_noGlobal_ReconLoss_NEW_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparation_1Out_OnlyCOSINEDiff_noGlobal_RECON_Loss_NEW_Trainer(
            model=model,
