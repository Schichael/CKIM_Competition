...
from federatedscope.contrib.trainer.laplacian_trainer_dom_sep_VAE_1_out_NEW import \
    LaplacianDomainSeparationVAE_1Out_NEW_Trainer
...
class LaplacianDomainSeparationVAE_1_out_NEW_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparationVAE_1Out_NEW_Trainer(
            model=model,
