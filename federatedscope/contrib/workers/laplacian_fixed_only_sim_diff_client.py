...
from federatedscope.contrib.trainer.laplacian_trainer_fixed_only_sim_diff import LaplacianTrainer_fixed_ONLY_SIM_DIFF
from federatedscope.contrib.trainer.laplacian_trainer_swd_mmd import LaplacianTrainer_SWD_MMD
...
class Laplacian_fixed_ONLY_SIM_DIFF_Client(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianTrainer_fixed_ONLY_SIM_DIFF(
            model=model,
