...
from federatedscope.contrib.trainer.laplacian_trainer_with_domain_with_autoenc_separation import \
    LaplacianDomainSeparationReconTrainer
...
class LaplacianDomainSeparationReconClient(Client):
    def __init__(self,
                 ID=-1,
                 server_id=None,
                 state=-1,
        ...
        trainer = LaplacianDomainSeparationReconTrainer(
            model=model,
