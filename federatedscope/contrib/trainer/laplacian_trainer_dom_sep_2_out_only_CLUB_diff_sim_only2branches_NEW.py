...
class LaplacianDomainSeparationVAE_2Out_OnlyCLUBDiffSim_only2branches_NEW_Trainer(
    ...
    def __init__(self,
        ...
        self.ctx.diff_local_global_metric = []
        self.ctx.MI_metric = []
...
def call_laplacian_trainer(trainer_type):
    if trainer_type == 'laplacian_trainer':
        trainer_builder = LaplacianDomainSeparationVAE_2Out_OnlyCLUBDiffSim_only2branches_NEW_Trainer
