...
class LaplacianDomainSeparationVAE_2Out_OnlyDiffProxLoss_NEW_Trainer(GraphMiniBatchTrainer):
    def __init__(self,
                 model,
                 omega,
                 data,
...
def call_laplacian_trainer(trainer_type):
    if trainer_type == 'laplacian_trainer':
        trainer_builder = LaplacianDomainSeparationVAE_2Out_OnlyDiffProxLoss_NEW_Trainer
