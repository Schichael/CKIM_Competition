...
class LaplacianDomainSeparation_1Out_OnlyCLUBDiff_noGlobal_NEW_Trainer(
...
def call_laplacian_trainer(trainer_type):
    if trainer_type == 'laplacian_trainer':
        trainer_builder = LaplacianDomainSeparation_1Out_OnlyCLUBDiff_noGlobal_NEW_Trainer
