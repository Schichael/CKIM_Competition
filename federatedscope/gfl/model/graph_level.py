...
from federatedscope.gfl.model.club import CLUB, VarUB
...
class GNN_Net_Graph(torch.nn.Module):
    ...
    def forward(self, data, sim_loss):
        ...
        return out_local_interm, out_interm, kld_loss_encoder, diff_loss_local, \
            diff_loss_interm, diff_loss_club_net, MI, x_local, x_interm
