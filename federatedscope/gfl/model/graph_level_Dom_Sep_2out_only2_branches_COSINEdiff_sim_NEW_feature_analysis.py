...
# graph_level_Dom_Sep_2out_only2_branches_COSINEdiff_sim_NEW_feature_analysis
...
class GNN_Net_Graph(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        return out_local_global, kld_loss_encoder, diff_local_global, x_local, x_global
