...
class GNN_Net_Graph(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        sim_global_interm = self.mse_loss(x_interm.detach(), x_global)
        ...
        return out_global, out_local_interm, out_interm, kld_loss_encoder, \
            diff_local_interm, sim_global_interm, x_local, x_interm, x_global
