...
# feature_analysis_graph_level_Dom_Sep_2out_only2_branches_CLUBdiff_sim_NEW
...
class GNN_Net_Graph(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        diff_local_global = self.club_diff.learning_loss(x_local, x_global)
        ...
        return out_local_global, kld_loss_encoder, diff_local_global, MI, x_local, x_global
