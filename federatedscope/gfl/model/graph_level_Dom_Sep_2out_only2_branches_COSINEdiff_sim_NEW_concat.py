...
# graph_level_Dom_Sep_2out_only2_branches_COSINEdiff_sim_NEW_concat
...
class GNN_Net_Graph(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        x_local_global = torch.concat([x_local_out, x_global_out], dim=-1)
        ...
        return out_local_global, kld_loss_encoder, diff_local, diff_global, x_local, x_global
