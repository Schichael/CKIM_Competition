...
# feature_analysis_graph_level_Dom_Sep_2out_only2_branches_FROBENIUSdiff_sim_NEW
...
class GNN_Net_Graph(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        diff_local = self.diff_loss(x_local, x_global.detach())
        diff_global = self.diff_loss(x_local.detach(), x_global)
