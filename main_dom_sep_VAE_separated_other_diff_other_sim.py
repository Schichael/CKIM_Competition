...
def train():
    ...
    init_cfg.data.save_dir = 'SEPARATED_NEW_OTHER_DIFF_OTHER_SIM_14_01_csd_0_diff_imp_0_01_sim_imp_1_lam_0_kld_imp_0_1_recon_imp_0_01'
    init_cfg.model.dropout = 0.5
    init_cfg.params = CN()
    init_cfg.params.alpha = 0.1
    init_cfg.params.csd_importance = 0.
    init_cfg.params.sim_importance = 1.
