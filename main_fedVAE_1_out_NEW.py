...
from federatedscope.contrib.trainer.laplacian_trainer_dom_sep_VAE_1_out_NEW import call_laplacian_trainer
...
from federatedscope.contrib.workers.laplacian_with_domain_separation_VAE_1_out_NEW_client import \
    LaplacianDomainSeparationVAE_1_out_NEW_Client
...
def train(lr, kld_ne_imp, kld_local_imp, kld_interm_imp, kld_global_imp, recon_imp, diff_interm_imp,
    ...
    init_cfg.data.save_dir = 'TEST_Graph-DC_FedVAE_1_out_NEW_lr_' + str(lr).replace('.', '_')
    ...
    runner = FedRunner(data=data,
                   ...
                   client_class = LaplacianDomainSeparationVAE_1_out_NEW_Client,
