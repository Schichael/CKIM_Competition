...
from federatedscope.contrib.trainer.laplacian_trainer_dom_sep_VAE_1_out import call_laplacian_trainer
...
metrics = [
    ...
    ('loss_out_interm', call_loss_out_interm_metric), ('loss_out_local_interm', call_loss_out_local_interm_metric),
...
def train(lr, kld_ne_imp, kld_local_imp, kld_interm_imp, kld_global_imp, recon_imp, diff_interm_imp,
              diff_local_imp, sim_global_interm_imp, csd_interm_imp):
    ...
    init_cfg.data.save_dir = 'Graph-DC_FedFOLA_ONLY_1_STEP_diffGlobalOut_lr_' + str(lr).replace('.', '_')
    ...
    init_cfg.params.csd_interm_imp = csd_interm_imp
    init_cfg.params.csd_importance = csd_interm_imp
    ...
    runner = FedRunner(data=data,
                   ...
                   client_class= LaplacianDomainSeparationVAE_1_out_Client,
