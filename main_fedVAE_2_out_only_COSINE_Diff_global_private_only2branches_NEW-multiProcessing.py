...
def train(lr, kld_ne_imp, diff_imp_global, diff_imp_local, csd_imp):
    ...
    init_cfg.data.save_dir = \
        'Graph-DC_2_out_only_COSINE_Diff_global_private_only_2_branches_NEW_sim_loss_lr_' + str(lr).replace(
...
if __name__ == '__main__':
    ...
    num_trainings = 1
    kld_ne_imps = [0] #A
    diff_imps = [0, 1, 0.1, 0.01, 0.001, 0.05]   #Now 0.0001
    #diff_global_imps = [0.01] #F    HERE  [0.0001, 0.001]
    #diff_local_imps = [0.01] #G
    csd_imp = 10 #H
