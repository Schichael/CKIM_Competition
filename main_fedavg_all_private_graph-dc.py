...
"""
All layers are private Let's see how that works
"""
...
def train(lr):
    cfg_file = 'scripts/B-FHTL_exp_scripts/Graph-DC/fedavg_all_private.yaml'
    ...
    init_cfg.data.save_dir = 'Graph-DC_FedAvg_All_private_lr_' + str(lr).replace('.', '_') + '_local_update_steps_1'
