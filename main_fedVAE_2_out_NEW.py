...
from federatedscope.contrib.trainer.laplacian_trainer_dom_sep_VAE_2_out_NEW import call_laplacian_trainer
...
def train(lr, kld_ne_imp, kld_local_imp, kld_interm_imp, kld_global_imp, recon_imp, diff_interm_imp,
    ...
    runner = FedRunner(data=data,
                   ...
                   client_class = LaplacianDomainSeparationVAE_2_out_NEW_Client,
