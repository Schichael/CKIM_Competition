...
from federatedscope.contrib.trainer.feature_analysis_laplacian_trainer_dom_sep_2_out_only_diff_sim_only2branches_NEW import \
    call_laplacian_trainer
from federatedscope.contrib.workers.feature_analysis_laplacian_with_domain_separation_2_out_onlyDiff_only2branches_NEW_client import \
    FeatureAnalysisLaplacianDomainSeparationVAE_2_out_onlyDiff_only2branches_NEW_Client
...
def train(lr, kld_ne_imp, diff_imp_global, diff_imp_local, csd_imp):
    ...
    init_cfg.data.save_dir = \
        'FeatureAnalysisGraph-DC_2_out_only_Frobenius_Diff_global_private_only_2_branches_NEW_sim_loss_lr_' + str(lr).replace(
    ...
    init_cfg.params.model_path = '/home/michael/Dropbox/Master thesis/results_graph_dc_new_lr_0_5/2_out/simple/frobenius/single_runs/Graph-DC_2_out_only_FrobeniusDiff_only_2_branches_NEW_sim_loss_lr_0_05_A0_F0_1_G0_1_H10/FedDomSep_GraphDC_gin_on_fs_contest_data_lr0.05_lstep1_'
    ...
    runner = FedRunner(data=data,
                   ...
                   client_class = FeatureAnalysisLaplacianDomainSeparationVAE_2_out_onlyDiff_only2branches_NEW_Client,
...
if __name__ == '__main__':
    ...
    diff_global_imps = [0.1] #F    HERE  [0.0001, 0.001]
