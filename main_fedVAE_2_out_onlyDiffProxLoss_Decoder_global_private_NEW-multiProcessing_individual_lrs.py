...
def train(lr, kld_ne_imp, diff_interm_imp, diff_local_imp, prox_loss_imp, csd_imp, recon_imp, kld_interm_imp):
    ...
    cfg_client = 'scripts/B-FHTL_exp_scripts/Graph-DC/cfg_per_client_from_isolated.yaml'
    ...
    init_cfg.data.save_dir = 'Graph-DC_FedVAE_2_out_only_DiffProx_Decoder_global_private_NEW_sim_loss_individual_lrs' + '_A'+ str(kld_ne_imp).replace('.', '_') + \
